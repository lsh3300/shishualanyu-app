    ...
    return (
      <div className="p-8">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-gray-800 mb-2">无效的重置链接</h2>
          <p className="text-sm text-gray-600">此重置密码链接已过期或无效，请重新申请。</p>
        </div>
  ...
  return (
    <div className="p-8">
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-gray-600">请输入您的新密码</p>
      </div>
