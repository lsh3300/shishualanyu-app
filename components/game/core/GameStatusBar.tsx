...
export function GameStatusBar() {
  ...
  return (
    <motion.div
      ...
      className="sticky top-0 left-0 right-0 z-40 bg-gradient-to-r from-indigo-600/95 to-blue-600/95 backdrop-blur-md border-b border-white/20 shadow-lg"
    >
      <div className="container mx-auto px-4 py-2">
        <div className="flex items-center justify-between">
          {/* 左侧：等级和经验 */}
          <div className="flex items-center gap-4">
            <Link href="/game/shop" className="hover:opacity-80 transition-opacity">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* 返回主页按钮（移动端） */}
            <Link href="/game/shop" className="sm:hidden">
...
export function CompactGameStatusBar() {
  ...
  return (
    <div className="sticky top-0 left-0 right-0 z-40 bg-indigo-600/95 backdrop-blur-md border-b border-white/20">
