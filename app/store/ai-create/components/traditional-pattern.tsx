...
export default function TraditionalPattern() {
  return (
    <div className="fixed inset-0 -z-5 pointer-events-none opacity-10">
      {/* 扎染放射纹样 - 左上角 */}
      <motion.svg
        className="absolute -top-20 -left-20 hidden h-64 w-64 lg:block"
        viewBox="0 0 200 200"
      ...
      {/* 蜡染几何纹样 - 右上角 */}
      <motion.svg
        className="absolute top-32 -right-16 hidden h-48 w-48 xl:block"
        viewBox="0 0 150 150"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      {/* 水墨线条 - 左下角 */}
      <motion.svg
        className="absolute bottom-20 left-10 hidden h-32 w-72 lg:block"
        viewBox="0 0 300 100"
      ...
      {/* 扎染纹样 - 右下角 */}
      <motion.svg
        className="absolute bottom-32 right-24 hidden h-56 w-56 xl:block"
        viewBox="0 0 200 200"
        initial={{ rotate: 0 }}
        animate={{ rotate: -360 }}
      ...
      {/* 蜡染纹样 - 中部装饰 */}
      <motion.div
        className="absolute left-1/4 top-1/2 hidden -translate-x-1/2 -translate-y-1/2 transform lg:block"
