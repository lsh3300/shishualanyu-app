...
import { ArrowLeft, Clock, User, Heart, MessageCircle, Share2, Play } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <div className="p-4 space-y-4">
        ...
        {/* Comments Section */}
        <div>
          <h3 className="font-semibold mb-3">课程评论</h3>
                  ...
                  <CardContent className="pt-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-muted-foreground mt-2">{comment.created_at}</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
